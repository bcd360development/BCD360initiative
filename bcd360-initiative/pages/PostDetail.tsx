...
const PostDetail: React.FC = () => {
      ...
      try {
        ...
        if (staticPost) {
          setPost({
            ...
            content: staticPost.content || (staticPost.summary + "\n\n(This is a placeholder for the full article content. In a live environment with database connectivity, the complete story would appear here.)"),
  ...
  useEffect(() => {
    ...
    // Reference to subcollection 'comments' inside the specific post document
